...
export const USER_SORT_OPTIONS: ControlOption[] = [
...
export const USER_FILTER_OPTIONS: ControlOption[] = [
	{ label: "Todos", value: "ALL" },
	{ label: "Activos", value: "ACTIVE" },
	{ label: "Desactivados", value: "DEACTIVATED" },
];

export const getUserFields = (): FieldDef<TowerRecord>[] => [
	{
	...
	{
		label: "Alias MP",
		cell: (row) => <span className="font-mono text-xs text-slate-500">{row.payments_alias || 'No asignado'}</span>
	},
	{
		label: "Creado",
		cell: (row) => (
